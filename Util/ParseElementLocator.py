...
"""
    ...
    # @ Author : antony_shi
    # @ Create : 2021/8/28 12:46
    # @ Email : antony_shi@163.com
    # @ Features : 用于解析配置文件，并获取页面元素定位表达式

"""
# 从Python的configparser模块中引入ConfigParser类
...
class ParseConfigFile:
    ...
    def get_items_section(self, section_name):
        ...
        注意：使用self.cf.items(sectionName)此种方法获取到配置文件中的options内容均被转换成小写，
        如loginPage.frame将被转换成 loginpage.frame
        """
